...
function ParentDashboard() {
  ...
  if (error === "No student linked") {
    return (
      <Box sx={{ textAlign: "center", mt: 10 }}>
        <Typography color="error" variant="h6">
          ⚠️ No student linked to this parent
        </Typography>
    ...
    <Box p={3}>
      ...
      <Card sx={{ mb: 3 }}>
        <CardContent>
          ...
          <Typography>{data.student.className}</Typography>
        </CardContent>
      </Card>
      ...
      <Card sx={{ mb: 3 }}>
        <CardContent>
          ...
          <Typography>Total: ₹{data.fees.totalFees}</Typography>
      ...
      <Grid container spacing={2}>
        {data.exams.length > 0 ? (
            ...
            <Grid item xs={12} md={6} key={index}>
              <Card>
                <CardContent>
                  ...
                  <LinearProgress
                    variant="determinate"
                    value={(exam.marks / exam.totalMarks) * 100}
                    sx={{ mt: 1 }}
                  />
                </CardContent>
              </Card>
          ...
          <Typography>No exam data found</Typography>
        )}
      </Grid>
    </Box>
  );
