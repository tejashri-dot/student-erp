    ...
    <div className={styles.app}>
          ...
          <div className="content-with-image">
            ...
            <div className="text-content">
              <p>
                ...
                technology to empower students to thrive in a globalized world.
                The school is located in the heart of the city, with easy access
                to public transportation and ample parking.
              </p>
              <p>
                It is a place where students can learn, grow, and thrive. All
                the facilities are designed to provide a safe and supportive
                environment for students to learn and grow. The school offers a
                wide range of extracurricular activities, including sports,
                music, art, and more, to help students develop their talents and
                interests.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-item">
              ...
              <p>
                Our curriculum is designed to foster creativity, critical
                thinking, and holistic development. We ensure every student is
                prepared to meet the challenges of tomorrow with confidence.
              </p>
            </div>
            ...
            <div className="feature-item">
              ...
              <ul>
                <li>
                  <strong>Efficient Communication:</strong> Stay updated on your
                  child's progress with instant notifications and messaging.
                </li>
                <li>
                  <strong>Online Exams & Results:</strong> Conduct and access
                  results seamlessly online.
                </li>
                <li>
                  <strong>Fee Management:</strong> Simplified online fee
                  payments with complete transparency.
                </li>
                <li>
                  <strong>Attendance Tracking:</strong> Keep track of your
                  child's attendance in real-time.
                </li>
              </ul>
            </div>
            ...
            <div className="feature-item">
              ...
              <p>
                Our team of highly qualified educators focuses on unlocking each
                child's potential, ensuring personalized attention and guidance.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="feature-block reverse">
            ...
            <div className="feature-content">
              ...
              <p>
                Our advanced online exam platform allows students to take tests
                from anywhere with ease. Whether it's MCQs or mixed question
                types, the system ensures a smooth, time-bound experience. Once
                evaluated, results are published instantly, providing detailed
                insights to students and parents.
              </p>
            </div>
          </div>
          ...
          <div className="feature-block">
            ...
            <div className="feature-content">
              ...
              <p>
                Say goodbye to long queues and manual processes. With our
                user-friendly fee management system, parents can pay fees online
                securely and conveniently. The system also provides detailed
                records of payments and dues, ensuring complete transparency and
                peace of mind.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="opportunities-grid">
            <div className="opportunity-item">
              ...
              and more to unleash creativity.
            </div>
            <div className="opportunity-item">
              <strong>Skill Development Programs:</strong> Workshops and events
              that enhance problem-solving, leadership, and teamwork skills.
            </div>
            <div className="opportunity-item">
              <strong>Community Initiatives:</strong> Programs that instill
        ...
        <div className="container">
          ...
          <div className="about-grid">
            <div className="about-item">
              <h3>Our Vision</h3>
              <p>
                We aim to nurture young minds with knowledge, values, and
                creativity. Our vision is to create confident individuals who
                are ready to face future challenges with responsibility and
                compassion.
              </p>
            </div>
            ...
            <div className="about-item">
              ...
              <p>
                With a well-structured curriculum, experienced faculty, and
                modern teaching methods, we ensure that every student achieves
                academic excellence while developing critical thinking skills.
              </p>
            </div>
            ...
            <div className="about-item">
              ...
              <p>
                Learning at our school goes beyond textbooks. We encourage
                students to explore sports, arts, and cultural activities to
                build a balanced personality and discover their hidden talents.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="info-grid">
            <div className="info-item">
              <h3>Admissions</h3>
              <p>
                Our admission process is simple, transparent, and merit-based.
                Parents can apply online or visit the school office for
                guidance, and our team will assist at every step.
              </p>
            </div>
            ...
            <div className="info-item">
              ...
              <p>
                We provide safe and reliable transport services with GPS-enabled
                buses and trained staff. Our routes are designed to cover major
                areas, ensuring convenience for families.
              </p>
            </div>
            ...
            <div className="info-item">
              ...
              <p>
                We believe parents are partners in education. Regular meetings,
                workshops, and open communication channels help us work together
      ...
      <section className="news-section" id="news">
        <div className="container">
          ...
          <p className="subtitle">
            Remain updated with the latest happenings and developments at Mint
          ...
          <div className="news-grid">
            <div className="news-card">
              ...
              <div className="news-content">
                ...
                <p>
                  The much-awaited Annual Day program was held in the school
                  auditorium with parents, teachers...
                </p>
            ...
            <div className="news-card">
              ...
              <div className="news-content">
                ...
                <span className="news-category">General</span>
                <p>
                  A team of three students from Class 9 represented our school
                  at the inter-district science quiz...
                </p>
            ...
            <div className="news-card">
              ...
              <div className="news-content">
                ...
                <span className="news-category">General</span>
                <p>
                  As part of its environmental awareness program, the school
                  organized a tree plantation drive on...
                </p>
      ...
      <section className="events-section">
        <div className="container">
          ...
          <p className="subtitle">
            Check out our upcoming events and activities designed to enrich the
            student experience.
          </p>
          ...
          <div className="events-grid">
            <div className="event-card">
              ...
              <div className="event-content">
                ...
                <p className="event-date">
                  February 13, 2026 8:30 PM - February 15, 2026
                </p>
                <p className="event-location">at School Auditorium</p>
                <span className="event-type">Annual Event</span>
                <p>
                  Join us at our Art Exhibition and Auction, where students'
                  artistic talents take center stage. View a stunning display of
                  paintings, sculptures, and crafts created by our talented
                  artists.
                </p>
              </div>
            </div>
            ...
            <div className="event-card">
              ...
              <div className="event-content">
                ...
                <p className="event-date">
                  February 11, 2026 7:30 PM - February 12, 2026
                </p>
                <p className="event-location">at School Open Ground</p>
                <span className="event-type">Annual Event</span>
                <p>
                  Get ready for a day filled with athleticism and sportsmanship
                  at our Sports Day Extravaganza. Students will compete in
                  various sports and games, and families are invited to cheer
                  them on.
                </p>
              </div>
            </div>
            ...
            <div className="event-card">
              ...
              <div className="event-content">
                ...
                <p>
                  Prepare to be amazed by the incredible talents of our students
                  at the School Talent Show. Singing, dancing, magic, and more!
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="announcements-section" id="announcements">
        <div className="container">
          ...
          <p className="subtitle">
            Stay informed with the latest news and updates from Mint
            International School.
          </p>
          ...
          <div className="announcements-list">
            ...
            <div className="announcement-card">
              ...
              <span className="announcement-type">Notice</span>
              <p>
                We're thrilled to introduce several new extracurricular clubs
                for our students.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="space-block">
            ...
            <div className="space-content">
              ...
              <p>
                At Mint International School, we believe the right environment
                nurtures creativity and curiosity. Our state-of-the-art
                classrooms, well-equipped labs, and resourceful libraries
          ...
          <div className="space-block reverse">
            ...
            <div className="space-content">
              ...
              <p>
                Education is more than books and exams. That's why we offer a
                wide array of extracurricular activities, including sports,
                music, art, drama, and leadership programs. Our holistic
                approach ensures that every child discovers their unique
                talents.
              </p>
            </div>
          </div>
      ...
      <section className="gallery-section" id="gallery">
        <div className="container">
          <h2>Gallery</h2>
          <p className="subtitle">
            Explore moments captured at Mint International School through our
            vibrant gallery.
          </p>
          ...
          <div className="gallery-grid">
            <div className="gallery-card">
              ...
              <div className="gallery-content">
                ...
                <p>
                  Odit quae corporis et rem doloremque sit corporis
                  consequuntur.
                </p>
              </div>
            </div>
          ...
          <div className="blog-grid">
            <div className="blog-card">
              ...
              <div className="blog-content">
                <h3>
                  The Future of Education: Embracing Technology in the Classroom
                </h3>
                <p className="blog-date">February 1, 2026 8:37 PM</p>
                <span className="blog-category">Education</span>
                <p>
                  Technology is transforming the way students learn and teachers
                  teach. From interactive...
                </p>
            ...
            <div className="blog-card">
              ...
              <div className="blog-content">
                <h3>
                  The Importance of Extracurricular Activities in Student
                  Development
                </h3>
                <p className="blog-date">January 12, 2026 10:35 PM</p>
                <span className="blog-category">Education</span>
                <p>
                  Academics are essential, but extracurricular activities play a
            ...
            <div className="blog-card">
              ...
              <div className="blog-content">
                <h3>
                  How to Foster a Positive School Culture: Tips for Educators
                </h3>
                <p className="blog-date">January 1, 2026 10:28 AM</p>
                <span className="blog-category">Education</span>
                <p>
                  A positive school culture is the cornerstone of student
                  success. Explore actionable tips for...
                </p>
                <div className="blog-tags">
                  <span className="tag">#Technology</span>
                  <span className="tag">#Future</span>
      ...
      <section className="legacy-section">
        <div className="container">
          ...
          <p>
            ...
            With a strong focus on character building and life skills, we have
            been shaping future leaders who make a positive impact on the world.
          </p>
        </div>
      </section>
          ...
          <div className="citizen-block">
            ...
            <div className="citizen-content">
              ...
              <p>
                ...
                community service initiatives, and ethical education, we empower
                our students to embrace diversity and thrive as responsible
                global citizens.
              </p>
            </div>
          </div>
